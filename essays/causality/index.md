...
- Finite thing: Something that is not self caused, it caused by external causes. The one infinite thing is substance, God or Nature, which is caused by nothing but itself. Everything finite, like a domino or a body, is a mode of it.
...
Each of those causes has its own causes, and each of those causes has its own causes, and so on back without end.
This chain has no first link. [1P28](https://ethica.bc.edu/#/element/1P28) says it goes back to infinity, so there is no starting point you could go and change.
So, if you wish to change any event in the world, you need to change everything that caused it, which is the whole order of nature.
And that whole order follows from God's nature and could not have been otherwise, see [1P33](https://ethica.bc.edu/#/element/1P33).
So as a result, you can't change anything in the world.
