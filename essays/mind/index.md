...
In the universe and causality we talked about cause and effect.
We talked that there is no randomness.
We talked that nothing is contingent and everything is conditioned.
As so far, we know the determined rules by nature, for example physics.
...
One single event in childhood can change the outcome of our behavior in the current moment as it effects our personality.

One association formed at age four can determine a reaction at age forty. The system is deterministic but unpredictable: every idea causes another idea, and those chains branch and converge across 86 billion neurons, each with 7,000 synaptic connections to others.

This is chaos theory applied inward. We can model weather with satellite data and supercomputers, yet a week out the forecast breaks down. Mind operates the same way: determined by causes, but the causal web is so dense that prediction collapses.
...
Mind is one thing expressing itself through many modes at once.
...
We naturally don't know the causes of our emotions and the way we make decision we make based on which specific knowledge,
 as humans, we just intuitively do it.
But if you crave to know how your mind works,
 you would have the key to the true freedom of understanding,
 not only external world, but also understanding our mind.
...
Mind does not control the body. The body does not control the mind. They are the same thing expressed under two attributes: thought and extension. A stone falls on your head: the physical event and the idea of that event are not cause and effect. They are parallel expressions of one reality viewed from two sides.

This dissolves the old problem. Descartes needed a pineal gland to bridge mind and body. Spinoza needs nothing: there is no gap. A mode of extension and the idea of that mode are one and the same thing, "though expressed in two ways."
...
There is no single "self" sitting at the center.
...
Imagination without the idea of truth, is the cause of errors in mind, for example imagination of someone who does not exist anymore and we think that he is still alive, is an error in mind.
Mind has designed to imagine similar realities with a flexibility regardless of conditions to reality, and this ability can lead to errors as we mismatch the imagination with reality because mind imagine things as in front of itself and get certainty of their existence, this will lead to distance from reality.
...
The idea of existence of someone by their own imagination is true, but the idea of existence of someone who does not exist anymore is false for us, because we know that he does not exist anymore. And with imagination, we get certain knowledge of their existence.

In other words, mind has the capability to believe it's own imagination with thinking to it.

### A note on how our sensory ideas cause errors and how Spinoza was imagining the sun is in the distance of 200 feet
...
- Each node/idea can be an idea, memory, feeling or the cause of what happened in the past, that's why each person's network memory is unique.
...
Example from [2P18](https://ethica.bc.edu/#/element/2P18):

You hear the word of "apple", you would immediately think of apple with no processing on the word apple itself, because you have seen apple and called it at the same time.

- A soldier and farmer see horse tracks in the road.

     - Soldier will get to the idea of horseman, and from there will get the the idea of war, and so on.
          - horse tracks -> horseman -> soldier -> war -> death
          - This is because soldier ideas in soldier's mind associated from tracks -> horseman -> war. Since this process of seeing them together has happened many times in soldier's past, the soldier will remember them together.
...
- Before he said that human body is composed of many complex separated parts which each function differently.
- That's why the mind doesn't have an adequate knowledge of the parts and complexity of them.
     - For example you feel your chest, but you don't know how your heart is working, or how your lungs are working, you don't feel those parts, but you feel the chest as a whole, so therefor, it's not an adequate knowledge.

You do not have direct access to your own mind. You know yourself only through what happens to your body: through sensations, modifications, impressions. The knowledge is real but inadequate: a partial view of a system too complex to perceive fully from inside.
...
Before this at [2P26] (that we said) and before this, he states that how mind's inadequate ideas are necessary as much as adequate ideas.
...
We all agree on triangle, I don't think if anyone wants to have an argue on triangle and their rules.

For every material thing, there is a specific idea of it in God.
We know that things has been determined, and the specific idea of their determined nature is an adequate idea as it will happen.
For example mixing 2 chemical matters, would produce to a specific result, adequate idea is to know the causes and effects in the process.
Since he believed the idea of doing something, and doing it are the same, as the parallelism, he keeps the connection of idea and action.

The invention of airplanes was an idea that exist inside God, which will work as it's determined.
Studying aerodynamics and understanding airflow and lots of other things of it is an adequate idea which will work as it's determined by nature rules.
Adequate idea must lead to driven nature(aerodynamics) and understanding it by eternal laws.
...
A true idea is the idea that would be unarguable, has no doubt and it's certain.
It's correspond to the nature of objective.
In a situation where we understand the idea and corresponding reality to it.
...
Ignoring true causes and calling them contingent will lead to falsy ideas which origin from first kind of knowledge.
...
Reality only bends over in imaginations(that's a natural functionality of mind)
You do not need to proof why Arthur is flying, because it's a sci-fi story, it's not real, it's the product of contingent imaginations where Arthur has been contingent to physics laws, unlike reality.
...
The nature of triangle has always been the same for eternity.
Reasons regarding adequate ideas for triangle does not concern time.
For the more complex reasons, we must look at things conditioned instead of contingent.
When a country attacks another, it's rooted and related to strive for power of all nature, just like how we see a group of lions attack another kind, we know that thats the way nature goes and we understand it,
 for our own wars we regard them as contingent of nature instead of conditioned to the facts of nature and how it's necessity.
So in our example if we go back the cause and effect of any event, we see it as the form of eternity and how it's necessary.
...
Every decision has a cause. That cause has its own cause. The chain extends back through your entire history: through childhood associations, bodily states, sensory impressions, and the ideas those impressions generated. You do not choose freely. You act from the necessity of your nature.

> [2P49](https://ethica.bc.edu/#/element/2P49): There is in the mind no volition or affirmation and negation, save that which an idea, inasmuch as it is an idea, involves.

Your idea and will are not separated, but they are part of the same process.
Thinking of an idea and willing are the same.
What we do in action is a direct result of our ideas, our action and ideas are the same.

### Don't worry, will exist

But this is not despair. Will and understanding are the same thing:
...
The true freedom is not in choosing without causes. That is incoherent. The true freedom is in understanding: having adequate ideas of the causes that determine you, and through that understanding, acting from your own nature rather than from confusion.
