...
- Errors arise from misinterpretation.
     - People think that they are doing the right thing, but they are intending to do something else.
     - If someone is doing wrong calculations, it's because they misinterpret the numbers in their mind.
...
## Nothing positive in a false idea

> There is nothing positive in ideas, which causes them to be called false.

A false idea has no special property that makes it false. Falsity is not a thing in the idea, it is a gap in it.
...
## Where falsity can arise

> Knowledge of the first kind is the only source of falsity, knowledge of the second and third kinds is necessarily true.

Imagination, opinion and assumption are all knowledge of the first kind. That is the only place falsity can arise.
