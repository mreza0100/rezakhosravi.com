...
We remember things associated with each other,
  if we conceive 2 things with each other,
...
> [E2p18] If the human body has once been affected by two or more bodies at the same time, when the mind afterwards imagines any of them, it will straightway remember the others also.
...
Let's say you have an old friend called Karen which you admire,
...
If mind imagine an image conditioned to time, past or future,
...
> [E2p44 note] The mind always regards things as present to itself, even though they be not in existence, until some causes arise which exclude their existence and presence.
...
This uniqueness has a degree which makes the object more memorable as it grows,
  ...
  Also it worth mentioning that if the object wouldn't makes us wonder at all, the contrary of Wonder will be Contempt.

This pattern recognition process will happen without our awareness and will carry
...
Furthermore, this hairstyle can easily be skin color or
  the shape of their face which is similar to someone you don't or do like.
...
So far we know that mind recognize patterns among objects by their own unique properties,
  but this is not only limited to people or objects, but also to situations or environments.

We recognize them by the very same way of objects, through their unique properties.
...
But furthermore to be more specific, for example, the face of people, we compare them one to another to find those
...
It's said that we remember things by their unique properties,
  likewise we forget them by the power of their uniqueness which left in mind.
...
The mind does not erase, it overwrites by new impressions which rearrange the old associations.

### Conclusion

> [Ethics 3P14](https://ethica.bc.edu/#/element/3P14): If the mind has once been affected by two emotions at the same time,
 it will, whenever it is afterwards affected by one of these two, be also affected by the other.

> [Ethics 3P15](https://ethica.bc.edu/#/element/3P15): Anything can, accidentally, be the cause of pleasure, pain, or desire.

- Memory is a liar and it's identified as a falsy source of knowledge
- Memory and mind actively makes connections between objects by their order and
...
- Pattern recognition can be out of the scope of our awareness.

In order to prevent falsy errors, we need to pay attention to this pattern recognition of things and
